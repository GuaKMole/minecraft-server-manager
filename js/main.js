...
function status(data) {
    console.log(data);
    document.getElementById("state").innerHTML = data.instance_state;
    if(data.instance_state == "running") {
      document.getElementById("ip").innerHTML = data.public_ip;
    }
}

function get_status_Server() {
  fetch('https://l3afsot0p5.execute-api.us-east-1.amazonaws.com/prod/get-state-server')
